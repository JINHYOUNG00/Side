...
// 활성 공급자는 KAKAO·GOOGLE(네이버는 Phase 7) — OAuthProvider enabled와 정합.

export type ActiveProvider = 'kakao' | 'google'

export const ACTIVE_PROVIDERS: readonly ActiveProvider[] = ['kakao', 'google'] as const
