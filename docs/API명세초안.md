...
GET  /reports/annual?year=2025 연 단위 결산(RPT-04) — summary 세 집계를 그 해 데이터로 재사용 (year 필수)
  res: { "year": 2025, "savingsRate": { "value": 40.0, "includesInvestment": true },
         "maturity": { "archivedCount": 2, "recordedCount": 1, "totalReceivedAmount": 3000000 },
         "envelopeSpentTotal": 80000 }
  저축률=그 해 사이클 카테고리별 계획액÷income 합, 만기=만기일(end_date) 그 해 보관 항목 실수령액,
  봉투집행=occurred_on 그 해 SPEND 합. year 2000~(현재 연도+1) 밖 400. 데이터 없는 해도 0/기본값.
