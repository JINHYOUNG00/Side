 ...
 * (SUG-01·SUG-02, {@link SuggestionService} — 연속 초과/잉여·만기 도래 판정). 스냅샷을 먼저 박아, 알림을
 * 받고 홈에 들어온 사용자에게 이미 체크리스트가 준비돼 있게 한다. 봉투·체크인 알림과 제안은 지급일과 무관하게 매일
 * 판정한다(각각 다음 지출일 윈도우·다음 지급일 전일·연속 패턴/만기 기준).
 *
