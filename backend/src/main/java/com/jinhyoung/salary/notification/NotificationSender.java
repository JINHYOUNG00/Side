 ...
 * 동일 알림 중복 발송 차단(notification_logs 기록 우선 — 멱등, 규칙 8)은 NOTI-04가 이 포트를 감싸 도입한다.
 * 인자 (type, userId, targetDate)는 NOTI-04의 unique(user_id, type, target_date) 키와 그대로 맞춰 둔다.
 */
